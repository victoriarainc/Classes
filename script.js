...
class Factory {
  constructor() {
    ...
    this.massBuild = function (quantity, color, trim, model) {
      ...
      this.trim = trim
      this.model = model
      return `Building ${this.quantity} ${this.color} ${this.trim} ${model}s`
    }
...
// Write your code below:
console.log(mazda3.customerBuild('yellow', 'touring', 'Mazda3', 'weather package, satellite radio, rear spoiler'))
...
// Write your code below:
console.log(miataRf.customerBuild('black', '', '', 'headlights, sports suspension, leather steering wheel, heated seats, adaptive cruise control'))
...
console.log(trailBlazer.massBuild(3500, 'blue', 'Sport', 'Trail Blazer'))
